...
export const getConfig = async () => {
    ...
    try {
        let config = (await import((getOs() === 'WIN' ? 'file://' : '') + find)).default;
        return config;
    }
    catch (err) {
        log.error(`Cannot find ${log.code('bd-scss.config.js')} in the root of your directory.\n\n` +
...
export const getDataFolder = () => {
    ...
    if (getOs() === 'WIN')
        ...
        folder = devPath || path.resolve(process.env.HOME, '.local', 'share', 'BetterDiscord', 'themes');
    else
 ...
 */
export const getMissingMeta = (meta) => {
